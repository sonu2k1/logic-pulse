...
const service = servicesData.services.find((s) => s.slug === "custom-app-development")!;
        ...
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            End-to-end app development solutions for mobile and web platforms.
                        </p>
                    </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">
                            Platforms We <span className="gradient-text">Develop For</span>
                        </h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            We build applications for all major platforms and devices.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-4 gap-6">
                        {[
                            { title: "iOS", desc: "Native iPhone & iPad apps", icon: "🍎" },
                            { title: "Android", desc: "Native Android applications", icon: "🤖" },
                            { title: "Web Apps", desc: "Progressive web applications", icon: "🌐" },
                            { title: "Cross-Platform", desc: "React Native & Flutter", icon: "📱" },
                        ].map((platform, idx) => (

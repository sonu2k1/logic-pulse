...
const service = servicesData.services.find((s) => s.slug === "seo-services")!;
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">
                                What are <span className="gradient-text">{service.title}?</span>
                            </h2>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Comprehensive SEO solutions to boost your online visibility and rankings.
                        </p>
                    </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Our SEO strategies have delivered measurable results for businesses across industries.
                        </p>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-r from-cyan-900/50 to-blue-900/50">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-gray-300 mb-8">
                        Let&apos;s discuss how our SEO services can help you dominate search results.
                    </p>

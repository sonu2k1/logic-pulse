...
const service = servicesData.services.find((s) => s.slug === "custom-web-design")!;
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            We combine aesthetics with functionality to create memorable digital experiences.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            { title: "User-Centered", desc: "Designs that prioritize user experience and engagement", icon: "👤" },
                            { title: "Mobile-First", desc: "Responsive designs that work seamlessly across all devices", icon: "📱" },
                            { title: "Performance", desc: "Optimized for speed and search engine visibility", icon: "⚡" },
                        ].map((item, idx) => (
                            <div key={idx} className="text-center glass rounded-2xl p-8">
